        ...
        <div class="container_12">
            <div class="grid_8">
                ...
                <table width="300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                    ...
                    <form name="form1" class="form-1 bot-2" method="post" action=""> 
                ...
                <table width="100%" align="left" border="3" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                    <td><br><br><br><br><br>
                        ...
                        <form name="form2" class="form-1 bot-2" method="post" action="">
                ...
                <div class="left-1">
                    ...
                    <form id="form-1" class="form-1 bot-2" action="#">
                        ...
                        <div>
                            ...
                            <input type="text" value="Address, City, Zip" onBlur="if (this.value == '')
                                        this.value = 'Address, City, Zip'" onFocus="if (this.value == 'Address, City, Zip')
                                                    this.value = ''">
                        </div>
                        <div class="select-2">
                            <label>Beds</label>
